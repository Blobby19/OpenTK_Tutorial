...
namespace OpenTKTutorial7
{
    class Game : GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            foreach(Volume v in objects)
            {
                verts.AddRange(v.GetVerts().ToArray());
                inds.AddRange(v.GetIndices().ToArray());
                colors.AddRange(v.GetColorData().ToArray());
                texcoords.AddRange(v.GetTextureCoords().ToArray());
